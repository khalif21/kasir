    ...
    public function data($id)
    {
        ...
        foreach ($detail as $item) {
            ...
            $row['aksi']        = '<div class="btn-group">
                                    <button type="button" onclick="deleteData(`'. route('pembelian_detail.destroy', $item->id_pembelian_detail) .'`)" class="btn bg-gradient-danger"><i class="fa fa-trash"></i></button>
                                </div>';
            $data[] = $row;
