...
class MemberController extends Controller
{
        ...
        return datatables()
            ...
            ->addColumn('aksi', function ($member) {
                return '
                    ...
                    <button type="button" onclick="editForm(`'. route('member.update', $member->id_member) .'`)" class="btn bg-gradient-info"> <i class="fa fa-edit"></i></button>
                    <button type="button" onclick="deleteData(`'. route('member.destroy', $member->id_member) .'`)" class="btn bg-gradient-danger"> <i class="fa fa-trash"></i></button>
    ...
    public function store(Request $request)
    {
        ...
        // Redirect ke halaman index setelah menyimpan data member
