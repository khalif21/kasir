    ...
    <div class="col-lg-12">
        <div class="card">
                            ...
                            <div class="col-lg-5">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button type="button" onclick="tampilProduk()" class="btn bg-gradient-info" ><i class="fa fa-arrow-right"></i></button>
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-lg-4">
                        <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                            ...
                            <div class="form-group row">
                                <label for="totalrp" class="col-3 control-label">Total</label>
                                <div class="col-8">
                                    <input type="text" id="totalrp" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="kode_member" class="col-lg-3 control-label">Pegawai</label>
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="kode_member" value="{{ $memberSelected->kode_member }}">
                                        <span class="input-group-btn">
                                            <button onclick="tampilMember()" class="btn bg-gradient-info" type="button"><i class="fa fa-arrow-right"></i></button>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="diskon" class="col-3 control-label">Diskon</label>
                                <div class="col-8">
            ...
            <div class="card-footer">
                <button type="submit" class="btn bg-gradient-primary float-right btn-simpan"><i class="fa fa-floppy-o"></i> Simpan Transaksi</button>
            </div>
        </div>
    </div>
</div>
